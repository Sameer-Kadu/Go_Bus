            ...
            <div id="video-frame" className="relative z-10 h-dvh w-screen overflow-hidden rounded-lg bg-blue-75 ">
                ...
                <div className="absolute left-0 top-0 z-40 size-full">
                    <div className="mt-24 px-5 sm:px-10">
                        <h1 className="special-font hero-heading text-blue-100">Booki<b
                            className="text-yellow-200">n</b>g</h1>

                        <p className="mb-5 max-w-64 font-robert-regular text-yellow-200">India's No. 1 Online Bus Ticket
                            Booking Site</p>
                        {/*<input type="text"/>*/}

                        <Button id="watch-trailer" title="Search Bus" leftIcon={<TiLocationArrow/>}
